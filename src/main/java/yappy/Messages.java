...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_FORMAT_DEADLINE =
            MESSAGE_INVALID_FORMAT_PREFIX + "deadline <name> /by <date>";
    public static final String MESSAGE_INVALID_FORMAT_DELETE =
            MESSAGE_INVALID_FORMAT_PREFIX + "delete <task number>";
    public static final String MESSAGE_INVALID_FORMAT_MARK =
            MESSAGE_INVALID_FORMAT_PREFIX + "mark <task number>";
    public static final String MESSAGE_INVALID_FORMAT_UNMARK =
            MESSAGE_INVALID_FORMAT_PREFIX + "unmark <task number>";
    public static final String MESSAGE_INVALID_FORMAT_EVENT =
            MESSAGE_INVALID_FORMAT_PREFIX + "event <name> /from <start> /to <end>";
